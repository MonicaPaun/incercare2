// Funcția pentru schimbarea temei între dark și light
  ...
  window.addEventListener('load', () => {
   // const loader = document.getElementById('loader-wrapper');
    ...
    if (window.location.pathname.includes('sistemul-digestiv.html')) {
...
window.onload = function () {
  ...
  document.querySelectorAll('.structura-image-btn').forEach(btn => {
  btn.addEventListener('click', () => {
    const modal = document.getElementById('structuraImageModal');
    const modalImg = document.getElementById('structuraModalContent');
    modal.style.display = "block";
    modalImg.src = btn.getAttribute('data-img');
  });
});

document.querySelector('.structura-close-modal').addEventListener('click', () => {
  document.getElementById('structuraImageModal').style.display = "none";
});

// Inchide modal și dacă dai click în afara imaginii
