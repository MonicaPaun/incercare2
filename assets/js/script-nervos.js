// Funcția pentru schimbarea temei între dark și light
  ...
  window.addEventListener('load', () => {
    ...
    if (window.location.pathname.includes('sistemul-nervos.html')) {
...
window.onload = function () {
  ...
  const btnShowStructuraImage = document.getElementById('openStructuraImageBtn');
const modalStructuraImage = document.getElementById('structuraImageModal');
const btnCloseStructuraImage = document.querySelector('.structura-close-modal');

btnShowStructuraImage.addEventListener('click', () => {
  modalStructuraImage.style.display = 'flex';
});

btnCloseStructuraImage.addEventListener('click', () => {
  modalStructuraImage.style.display = 'none';
});

modalStructuraImage.addEventListener('click', (e) => {
  if (e.target === modalStructuraImage) {
    modalStructuraImage.style.display = 'none';
  }
});


const btnShowEncefalImage = document.getElementById('btnShowEncefalImage');
const modalEncefalImage = document.getElementById('modalEncefalImage');
const btnCloseEncefalImage = modalEncefalImage.querySelector('.structura-close-modal');

btnShowEncefalImage.addEventListener('click', () => {
  modalEncefalImage.style.display = 'flex';
});

btnCloseEncefalImage.addEventListener('click', () => {
  modalEncefalImage.style.display = 'none';
});

modalEncefalImage.addEventListener('click', (e) => {
  if (e.target === modalEncefalImage) {
    modalEncefalImage.style.display = 'none';
  }
});
