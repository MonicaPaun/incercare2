  ...
  // Verificare dacă pagina a fost reîncărcată
  let isRefresh = performance.navigation.type === performance.navigation.TYPE_RELOAD;
  console.log("Este refresh?", isRefresh);

  // Dacă e refresh și NU suntem pe index.html sau /
