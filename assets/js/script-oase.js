// Funcția pentru schimbarea temei între dark și light
  ...
  window.addEventListener('load', () => {
   // const loader = document.getElementById('loader-wrapper');
    ...
    if (window.location.pathname.includes('sistemul-osos.html')) {
...
window.onload = function () {
  ...
  const btn2 = document.getElementById("openImageBtn2");
  const close2 = modal2.querySelector(".close-modal");
  ...
  // Lightbox pentru imagine
  const modal3 = document.getElementById("imageModal3");
  const btn3 = document.getElementById("openImageBtn3");
  const close3 = modal3.querySelector(".close-modal");

  btn3.onclick = () => modal3.style.display = "block";
  close3.onclick = () => modal3.style.display = "none";
  window.addEventListener("click", (e) => {
    if (e.target === modal3) modal3.style.display = "none";
  });

   const modal4 = document.getElementById("imageModal4");
  const btn4 = document.getElementById("openImageBtn4");
  const close4 = modal4.querySelector(".close-modal");

  btn4.onclick = () => modal4.style.display = "block";
  close4.onclick = () => modal4.style.display = "none";
  window.addEventListener("click", (e) => {
  ...
  document.querySelectorAll(".open-image-btn").forEach(btn => {
    btn.addEventListener("click", () => {
      const modalImgId = btn.getAttribute("data-target");
      const imgSrc = btn.getAttribute("data-src");
      const modal = btn.nextElementSibling;
      if (modal && modal.querySelector(`#${modalImgId}`)) {
...
document.getElementById("sinovialeTrigger").addEventListener("click", () => {
    const extra = document.getElementById("sinovialeExtra");
