// Funcția pentru schimbarea temei între dark și light
  ...
  window.addEventListener('load', () => {
   // const loader = document.getElementById('loader-wrapper');
    ...
    if (window.location.pathname.includes('sistemul-respirator.html')) {
...
window.onload = function () {
  ...
  // Tab switching logic
  document.querySelectorAll('#animale .tab-btn').forEach(button => {
    button.addEventListener('click', () => {
      const tab = button.dataset.tab;

      // Remove active classes
      document.querySelectorAll('#animale .tab-btn').forEach(btn => btn.classList.remove('active'));
      document.querySelectorAll('#animale .tab-content').forEach(content => content.classList.remove('active'));

      // Add active on clicked tab and content
